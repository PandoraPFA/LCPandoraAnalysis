...
void AnalysePerformance(TFile *pTFile, const std::string &outputRootFileName)
{
    ...
    TH1F *pPFA = new TH1F("fPFA", "total PFA energy", 100000, 0., 5000.);
    TH1F *pPFA_nu = new TH1F("fPFA_nu", "total energy + nu", 100000, 0., 5000.);
    TH1F *pPFA_nufwd = new TH1F("fPFA_nufwd", "total energy + nu + fwd", 100000, 0., 5000.);
    TH1F *pPFA_udscb = new TH1F("fPFA_udscb", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_uds = new TH1F("fPFA_uds", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_udsHM20 = new TH1F("fPFA_udsHM20", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_udsHM10 = new TH1F("fPFA_udsHM10", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_udsHP10 = new TH1F("fPFA_udsHP10", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_udsHP20 = new TH1F("fPFA_udsHP20", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_cb = new TH1F("fPFA_cb", "total energy", 100000, 0., 5000.);
    TH1F *pPFA_1 = new TH1F("fPFA_1", "total energy 0.0-0.1", 100000, 0., 5000.);
    TH1F *pPFA_2 = new TH1F("fPFA_2", "total energy 0.1-0.2", 100000, 0., 5000.);
    TH1F *pPFA_3 = new TH1F("fPFA_3", "total energy 0.2-0.3", 100000, 0., 5000.);
    TH1F *pPFA_4 = new TH1F("fPFA_4", "total energy 0.3-0.4", 100000, 0., 5000.);
    TH1F *pPFA_5 = new TH1F("fPFA_5", "total energy 0.4-0.5", 100000, 0., 5000.);
    TH1F *pPFA_6 = new TH1F("fPFA_6", "total energy 0.5-0.6", 100000, 0., 5000.);
    TH1F *pPFA_7 = new TH1F("fPFA_7", "total energy 0.6-0.7", 100000, 0., 5000.);
    TH1F *pPFA_L7A = new TH1F("fPFA_L7A", "total energy <0.7", 100000, 0., 5000.);
    TH1F *pPFA_L7Aud= new TH1F("fPFA_L7Aud", "total energy <0.7 ud", 100000, 0., 5000.);
    TH1F *pPFA_L7As = new TH1F("fPFA_L7As", "total energy <0.7 s", 100000, 0., 5000.);
    TH1F *pPFA_L7Ac = new TH1F("fPFA_L7Ac", "total energy <0.7 c", 100000, 0., 5000.);
    TH1F *pPFA_L7Ab = new TH1F("fPFA_L7Ab", "total energy <0.7 b", 100000, 0., 5000.);
    TH1F *pPFA_L7ANoFwd = new TH1F("fPFA_L7ANoFwd", "total energy <0.7 - bad", 100000, 0., 5000.);
    TH1F *pPFA_QQ   = new TH1F("fPFA_QQ", "total energy - true E", 20000, -500., 500.);
    TH1F *pPFA_QQ8  = new TH1F("fPFA_QQ8", "total energy - true E 8", 20000, -500., 500.);
    TH1F *pPFA_8  = new TH1F("fPFA_8", "total energy 0.7-0.8", 100000, 0., 5000.);
    TH1F *pPFA_9  = new TH1F("fPFA_9", "total energy 0.8-0.9", 100000, 0., 5000.);
    TH1F *pPFA_10 = new TH1F("fPFA_10","total energy 0.9-1.0", 100000, 0., 5000.);
    TH1F *pPFA_11 = new TH1F("fPFA_11","total energy 0.9-0.925", 100000, 0., 5000.);
    TH1F *pPFA_12 = new TH1F("fPFA_12","total energy 0.925-0.95", 100000, 0., 5000.);
    TH1F *pPFA_13 = new TH1F("fPFA_13","total energy 0.95-0.975", 100000, 0., 5000.);
    TH1F *pPFA_14 = new TH1F("fPFA_14","total energy 0.975-1.0", 100000, 0., 5000.);
